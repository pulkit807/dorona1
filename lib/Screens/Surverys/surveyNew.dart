  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        isQuestion.contains(true)?Padding(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: <Widget>[
              Center(child: Text('Question 2',style: GoogleFonts.aleo(color: Colors.black,fontSize: 30.0),)),
              SizedBox(height: 20,),
              Center(
                child: Container(
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.aleo(color: Colors.black,fontSize: 20.0),
                      textAlign: TextAlign.center,
                    )),
              ),
                                ...
                                children: <Widget>[
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Text(using.displayContent,style: GoogleFonts.aleo(fontSize: 20),)
                                    ],
                                  ),
                                  Divider(
    ...
    return FadeInRight(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: <Widget>[
            Center(child: Text('Question 3',style: GoogleFonts.aleo(fontSize: 30.0),)),
...
//                                          print(value);
                                            ...
                                            Text(question.displayContent,style: GoogleFonts.aleo(fontSize: 16.0),)
                                          ],
                                        ),
                                      ),
                                    ),
    ...
    return FadeInRight(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: <Widget>[
            Center(child: Text('Question 4',style: GoogleFonts.aleo(fontSize: 30),)),
                                ...
                                children: <Widget>[
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Text(using.displayContent,style: GoogleFonts.aleo(fontSize: 16.0),)
                                    ],
                                  ),
                                  Divider(
                                    height: index < usingCollection.length
